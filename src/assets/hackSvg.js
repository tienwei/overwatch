...
export const hackSvg = (
  <span
    dangerouslySetInnerHTML={{
      __html: `<svg width="120px" height="120px" viewBox="0 0 120 120" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <g fill="none" fill-rule="evenodd" stroke-width="5" stroke="coral" stroke-opacity="0.9">
